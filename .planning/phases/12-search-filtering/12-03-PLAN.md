...
<task type="auto">
  ...
  <done>Detail pane supports search result views. Backend depot search command available. SearchResultsView renders both submitted CL and depot path search results.</done>
</task>
