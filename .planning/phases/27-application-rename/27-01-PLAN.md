...
<task type="auto">
  <name>Task 4: Add MIT LICENSE file</name>
  <files>LICENSE</files>
  <action>
    Create LICENSE file at project root with MIT license text and copyright 2026.

    Use standard MIT license template with:
    - "MIT License" header
    - Copyright (c) 2026
    - Standard MIT license permissions and conditions text
  </action>
  <verify>Run `ls LICENSE` to confirm file exists and `head -3 LICENSE` to verify MIT header and copyright year</verify>
  <done>LICENSE file exists at project root with MIT License header and copyright 2026</done>
</task>
...
7. `ls LICENSE && head -3 LICENSE` shows MIT License file with copyright 2026
</verification>
...
- MIT LICENSE file created with copyright 2026
</success_criteria>
