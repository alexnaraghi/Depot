 ...
 *
 * Writes settings to:
 * - Windows: %APPDATA%\com.depot.client\settings.json
 * - Linux: ~/.config/com.depot.client/settings.json
 * - macOS: ~/Library/Application Support/com.depot.client/settings.json
 *
...
export async function seedSettings(): Promise<void> {
  ...
  const storeDir = join(appDataDir, 'com.depot.client')
