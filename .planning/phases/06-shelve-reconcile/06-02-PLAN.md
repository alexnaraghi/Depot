...
must_haves:
  truths:
    ...
    - "User can unshelve all files from a shelf back to the shelf's original changelist (target CL is always the original — intentional simplification per context decision)"
