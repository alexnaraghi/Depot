...
<task type="checkpoint:human-verify" gate="blocking">
  ...
  <how-to-verify>
    ...
    7. **Context menu on search results (SRCH-01):**
       - Right-click a submitted CL result in the search results view
       - Verify: context menu appears with "Copy CL Number" and other operations
       - Right-click a depot path result
       - Verify: context menu appears with "Copy Depot Path" option
    8. **Author click (SRCH-03):**
       - In submitted CL search results, click an author name
       - Verify: results filter to show only that author's recent changes
       - Verify: author names have a link-like visual style (color/underline on hover)
    9. **Edge cases:**
